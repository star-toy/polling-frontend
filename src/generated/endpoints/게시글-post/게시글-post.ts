...
export const getPostById = (
  ...
  return customInstance<Post>({ url: `/v1/posts/${postId}`, method: 'GET', signal }, options);
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getPostById>>> = ({ signal }) =>
    getPostById(postId, requestOptions, signal);
...
export const deletePost = (postId: number, options?: SecondParameter<typeof customInstance>) => {
  return customInstance<string>({ url: `/v1/posts/${postId}`, method: 'DELETE' }, options);
};
...
export const findAllPosts = (
  ...
  return customInstance<Post[]>({ url: `/v1/posts`, method: 'GET', signal }, options);
};
...
>(options?: {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof findAllPosts>>> = ({ signal }) =>
    findAllPosts(requestOptions, signal);
 ...
 * @summary 새로운 게시글 생성
 */
export const createPost = (post: Post, options?: SecondParameter<typeof customInstance>) => {
  return customInstance<Post>(
    {
      url: `/v1/posts`,
      method: 'POST',
