...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof findOptionById>>> = ({ signal }) =>
    findOptionById(optionId, requestOptions, signal);
...
export const deleteOption = (
  ...
  return customInstance<string>({ url: `/v1/options/${optionId}`, method: 'DELETE' }, options);
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof findByPollId>>> = ({ signal }) =>
    findByPollId(pollId, requestOptions, signal);
